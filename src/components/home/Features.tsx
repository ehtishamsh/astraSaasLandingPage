  ...
  return (
    <div className="mt-28 max-w-7xl mx-auto text-center pb-14 px-4">
      ...
      <div className="mt-2 grid grid-cols-2 gap-6 pt-24">
        <div className="border border-borderMainColor rounded-2xl flex flex-col gap-6 bg-mainColor-800 px-6 py-7">
          <img
            src="/bento1.png"
          ...
          <div className="flex flex-col gap-2 text-left">
            ...
            <p className="text-sm text-mainColor-100/80">
              Tailor dashboards to display the metrics and KPIs most relevant to
              your business needs.
            </p>
          </div>
        </div>
        <div className="border border-borderMainColor rounded-2xl flex flex-col gap-6 bg-mainColor-800 px-6 py-7">
          ...
          />
          <div className="flex flex-col gap-2 text-left">
            <h3 className="text-lg text-mainColor-100">Automated Reporting</h3>
            <p className="text-sm  text-mainColor-100/80">
        ...
        <div className="border border-borderMainColor rounded-2xl flex flex-col gap-6 bg-mainColor-800 px-6 py-7">
          ...
          <div className="flex flex-col gap-2 text-left">
            ...
            <p className="text-sm  text-mainColor-100/80">
              Visualize vendor activities and performance with intuitive graphs
              updated every month.
            </p>
          </div>
        </div>
