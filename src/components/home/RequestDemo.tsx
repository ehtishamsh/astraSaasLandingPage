...
function RequestDemo() {
  return (
    <div className="mt-20 max-lg:mt-16 max-md:mt-8 max-w-7xl mx-auto pb-14 px-4">
      <div className="relative inline-block">
        <img src="/demo.png" alt="requestDemo" className="w-full h-auto" />
        <div className="absolute max-w-4xl max-md:max-w-xl mx-auto text-center inset-0 flex flex-col items-center justify-center">
          <Reveal>
            <h2 className="text-[42px] mb-6 max-md:mb-3 text-mainColor-100 tracking-tight leading-normal max-md:text-2xl font-medium">
              Take the next step toward optimized & streamlined operations
            </h2>
          </Reveal>
          <Reveal delay={0.35}>
            <p className="text-mainColor-200/50 max-md:text-sm text-lg text-center max-w-4xl px-5 mx-auto">
